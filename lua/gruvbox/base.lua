...
local base_group = lush(function()
  return {
    ...
    GruvboxRedUnderline {gui = styles.undercurl, sp = red, fg = red},
    GruvboxGreenUnderline {gui = styles.undercurl, sp = green, fg = green},
    GruvboxYellowUnderline {gui = styles.undercurl, sp = yellow, fg = yellow},
    GruvboxBlueUnderline {gui = styles.undercurl, sp = blue, fg = blue},
    GruvboxPurpleUnderline {gui = styles.undercurl, sp = purple, fg = purple},
    GruvboxAquaUnderline {gui = styles.undercurl, sp = aqua, fg = aqua},
    GruvboxOrangeUnderline {gui = styles.undercurl, sp = orange, fg = orange},
